...
describe('TabsComponent', () => {
    ...
    it('should emit tabChanged and update model when a new tab is clicked', () => {
        ...
        expect(component.value()).toBe('advanced');
    ...
    it('should update the view when the value signal is updated externally', () => {
